...
vlog -work work ClockGen_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax ClockGen_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.ClockGen_tb work.glbl

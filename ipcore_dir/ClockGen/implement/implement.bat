...
xst -ifn xst.scr
move ClockGen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ClockGen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ClockGen_exdes.ucf ClockGen_exdes

echo 'Running map'
map -timing -pr b ClockGen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ClockGen_exdes -w routed.ncd routed.v
cd ..
